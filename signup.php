...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			$query = "insert into users (user_id,user_name,e_mail,password) values ('$user_id','$user_name','$e_mail','$password')";
...
<body>
    <div class="container">
        <form class="form" id="login" method="post">
            ...
            <p class="form__text">
                <a class="form__link" href="http://localhost/login/login.php" id="linkLogin">Already have an account? Sign in</a>
            </p>
        </form>
